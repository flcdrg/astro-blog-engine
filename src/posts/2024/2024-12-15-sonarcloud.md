...
description: How to publish .NET code coverage from Azure Pipelines to both Azure DevOps and SonarQube Cloud, including setup steps, tasks, and key configuration points.
tags:
- Azure DevOps
- Azure Pipelines
---

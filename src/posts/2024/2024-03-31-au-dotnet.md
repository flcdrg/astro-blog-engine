...
You can then create a [PowerShell Class](https://learn.microsoft.com/en-us/dotnet/api/system.management.automation.powershell?view=powershellsdk-7.4.0&WT.mc_id=DOP-MVP-5001655) instance like this:
...
You can capture any output via the [`Streams`](https://learn.microsoft.com/en-us/dotnet/api/system.management.automation.powershell.streams?view=powershellsdk-7.4.0&WT.mc_id=DOP-MVP-5001655) property. eg. Here I am logging any errors from PowerShell as a GitHub Action error:
...
Running specific PowerShell cmdlets can be done via the [`AddCommand`](https://learn.microsoft.com/en-us/dotnet/api/system.management.automation.powershell.addcommand?view=powershellsdk-7.4.0&WT.mc_id=DOP-MVP-5001655) method. eg.

```csharp
ps.AddCommand("Set-Location").AddParameter("Path", directory).Invoke();
```

Whereas running arbitrary PowerShell scripts is done via the [`AddScript`](https://learn.microsoft.com/en-us/dotnet/api/system.management.automation.powershell.addscript?view=powershellsdk-7.4.0&WT.mc_id=DOP-MVP-5001655) method. eg.
...
One thing to remember is you must call the [`Invoke`](https://learn.microsoft.com/en-us/dotnet/api/system.management.automation.powershell.invoke?view=powershellsdk-7.4.0&WT.mc_id=DOP-MVP-5001655) method to actually run the scripts or commands you've just added.
